---
name: Make Hamburger Menu Responsive After Login
about: Adjust hamburger menu position to top-left corner and make it responsive
title: '[UI] Make hamburger menu responsive and position it in top-left corner after login'
...
_Add screenshots showing current vs expected behavior_
